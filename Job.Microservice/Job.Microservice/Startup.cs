...
using Job.Microservice.Services;
namespace Job.Microservice
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var db = Configuration["PMA_DB"] ?? "jobs";
            var port = Configuration["PMA_PORT"] ?? "3306";
            var user  = Configuration["PMA_USER"] ?? "root";
            var password = Configuration["PMA_PASSWORD"] ?? "Le237c!elC#Ovfc";
            ...
            JobServiceCollectionExtensions.AddAutoMapper(services, GetAssemblyNamesToScanForMapperProfiles());
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Job.Microservice");
            });
